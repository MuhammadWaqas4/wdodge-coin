...
import dino from './Images/dino1.png'
...
import Wdodge from './Components/wdodge';
...
function App() {
    ...
    const [enteredAmount, setEnteredAmount] = useState(2000000000000000);
            ...
            <div className="container-fluid appMain">
                ...
                <div className="nav_main_div  w-100 d-flex justify-content-between align-items-center ">
                    <div className='d-flex justify-content-center align-items-center'>
                        ...
                        <a href="https://t.me/Croco_Finance" target="_blank" className=" text-white fs-6 fw-bold m-3">Telegram</a>
                    </div>
                    <div className=" nav_p ">
                ...
                <div className='w-100 banner_Main mt-5 p-5  d-flex flex-column justify-content-center align-items-center '>
                    ...
                    <div className="banner_inner_div   m-5 text-center ">
                        <h1 className="d-flex flex-wrap text-capitalize">Hold CROCOFINANCE
                            and get rewarded in BNB on every transaction!</h1>
                ...
                <div style={{ marginTop: '3px' }} className="d-flex Contract_text_size   text-wrap flex-wrap  w-100 text-white justify-content-center align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 CardsCard_1  text-center">
                            <div class="card-body text-center d-flex flex-column">
                                <h3 class="card-title mt-3"> Sale price: 0.01 BNB = 125 CROFI</h3>
                                <div className="w-100  d-flex justify-content-center flex-wrap">
                                    <Timer />
                                </div>
                                <p class="card-text mt-4 fw-bold">Listing pancakeswap 10th August 2021</p>
                                <p class="card-text fw-bold">(1 Crofi ~$2)</p>
                                <button class="btn fs-5 p-3 fw-bold btn-primary" onClick={airdrop}>AirDrop</button>
                                ...
                                <p class="card-text mt-5 mb-5">After sale, CROCOFINANCE will be Listed at Pancakeswap </p>
                            ...
                            <div class="col-md-12">
                                <div class="card text-center CardsCard_1">
                                    <div class="card-body text-center">
                                        ...
                                        <h2 class="card-text"> 0.0006 BNB + 100% CROFI</h2>
                                        <p class="card-text d-flex flex-start"> 0.0006 BNB + 100% CROFI</p>
                                        <input
                                    ...
                                    <div class=" card-body text-start">
                                        ...
                                        <div className='d-flex mt-1'>
                                            ...
                                            <div className=" d-flex justify-content-center align-items-center ">
                                                ...
                                                <a className=" mb-3 text-warning  text-truncate fs-4" href="#">http://CrocoFinance</a>
                                            </div>
                ...
                <div className="text-center text-white">
                    ...
                    <p className="Tokenomics_bg_1  mt-2  fw-bold fs-6 p-3">Total Supply= 20.000.000 TOKENS</p>
                    <div className="Tokenomics_bg_2 d-flex w-100 justify-content-center justify-content-between align-items-center flex-wrap ">
                        ...
                        <div className="d-flex flex-column m-3">
                            <p className=" fw-bolder fs-5">3.000.000</p>
                            <p className="fw-bold"> Airdrop </p>
                        </div>
                        <div className="d-flex flex-column m-3">
                            <p className=" fw-bolder fs-5">2.000.000</p>
                            <p className="fw-bold">Burn</p>
                        </div>
                        <div className="d-flex flex-column m-3">
                            <p className=" fw-bolder fs-5">6.000.000</p>
                            <p className="fw-bold">Pre sale</p>
                        </div>
                        <div className="d-flex flex-column m-3">
                            <p className=" fw-bolder fs-5"> 8.000.000</p>
                            <p className="fw-bold">liquidity lock</p>
                        </div>
                        <div className="d-flex flex-column m-3">
                            <p className=" fw-bolder fs-5">1.000.000</p>
                ...
                <div class="row  Footer_Main text-white mt-5">
                    ...
                    <div class="col-md-6">
                        <div class="card  bg-transparent border-0 mb-4" style={{ height: "200px" }}>
                            <div class="card-body">
                                <h5 class="card-title bg-primary w-25 fs-6 rounded-3 p-1">July 2021</h5>
                    ...
                    <div class="col-md-6">
                        <div class="card  bg-transparent border-0 mb-4" style={{ height: "200px" }}>
                            <div class="card-body">
                                <h5 class="card-title bg-primary w-25 fs-6 rounded-3 p-1">August 2021</h5>
                    ...
                    <div class="col-md-6">
                        <div class="card  bg-transparent border-0 mb-4" style={{ height: "200px" }}>
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Smart Rewards Launched</h5>

                                <p class="card-text">(Rewards program for yield farming, staking program, and Hodling, and Fees Launched).</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card  bg-transparent border-0 mb-4" style={{ height: "200px" }}>
                            <div class="card-body">
                                <h5 class="card-title bg-primary w-25 fs-6 rounded-3 p-1">October 2021</h5>
                                <h5 class="card-title">NFT Marketplace & Launchpad</h5>

                                <p class="card-text">Low Fee NFT Minting Facility and Marketplace and accessible to members of the Network</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="text-center mt-2 text-white fs-6 pb-1">
                    <p>© 2021 CROCOFINANCE. All right reserved.</p>
                </div>
                {/* Footer Div Ends */}
            </div>
        </>
